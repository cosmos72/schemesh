...
- [x] customizable prompts, set by environment variables `$SCHEMESH_PS0` and `$SCHEMESH_PS1`
      or by calling user-defined functions
...
let
  schemesh = pkgs.fetchgit {
    ...
    rev = "refs/tags/v1.0.2"; # or: "refs/heads/main"
