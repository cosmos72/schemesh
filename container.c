...
static void define_bytespan_functions(void) {
  eval("(begin\n"
       ...
       "  (define bytespan-peek-beg)\n"  /* return start offset into underlying bytevector */
       "  (define bytespan-peek-end)\n"  /* return end offset into underlying bytevector */
  ...
  eval("(let ()\n"
       ...
       "      (bytevector-copy! old-vec (bytespan-beg sp) new-vec 0 len)\n"
       ...
       "  (bytespan-end-set! sp (fx+ n (bytespan-beg sp)))))\n"
       "\n"
...
static void define_charspan_functions(void) {
  ...
  eval("(let ()\n"
       ...
       "      (string-copy! old-vec (charspan-beg sp) new-vec 0 len)\n"
       ...
       "  (charspan-end-set! sp (fx+ n (charspan-beg sp)))))\n"
       "\n"
