...
(library (scheme2k bootstrap (1 0 0))
  (export
      ...
      first-value first-value-or-void let-macro iterate iterate-any raise-assert* reverse-macro
...
(define (iterate-any iter proc)
  (assert* 'iterate-any (procedure? iter))
