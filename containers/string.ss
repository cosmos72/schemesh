...
(define string-every
  (case-lambda
    ((proc)
      #t)
    ((proc str)
      (not (string-any (lambda (ch) (not (proc ch))) str)))
    ((proc str1 str2)
      (not (string-any (lambda (ch1 ch2) (not (proc ch1 ch2))) str1 str2)))
    ((proc str1 str2 str3)
      (not (string-any (lambda (ch1 ch2 ch3) (not (proc ch1 ch2 ch3))) str1 str2 str3)))
    ((proc . str-list)
      (let ((n (apply fxmin (map string-length str-list))))
        (let %every ((i 0))
          (if (fx<? i n)
