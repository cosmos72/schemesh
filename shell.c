...
void define_library_shell(void) {
  eval(
      ...
      "    (rnrs)\n"
      "    (rnrs mutable-pairs)\n"
      "    (only (chezscheme) foreign-procedure fxlogand record-writer reverse!)\n"
      ...
      "              ((fx<? num 512) (cons 'killed  (signal-number->name (fxlogand num 255))))\n"
      "              ((fx<? num 768) (cons 'stopped (signal-number->name (fxlogand num 255))))\n"
