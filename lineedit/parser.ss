...
(library (schemesh lineedit parser (0 1))
  (export
    ...
    make-parser parser?
    parser-name parser-parse parser-parse-list parser-parse-forms parser-parse-paren
...
;;   parser-parse-list will parse and return a list of forms,
;;   parser-parse-forms will parse a list of forms,
;;     and return it prefixed by a suitable (begin ...) or (shell ...) etc
...
;; create a new parser
(define (make-parser name parse parse-list parse-forms parse-paren)
  ...
  (%make-parser name parse parse-list parse-forms parse-paren))
