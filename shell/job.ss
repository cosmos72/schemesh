...
(library (schemesh shell job (0 8 3))
  ...
  (import
    ...
    (schemesh port redir)
    (schemesh port stdio)
    (only (schemesh lineedit vline)    vline-display/bytespan)
    (only (schemesh lineedit vlines)   vlines-iterate)
    (only (schemesh lineedit vhistory) vhistory-iterate vhistory-path-set!)
