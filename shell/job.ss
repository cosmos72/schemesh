...
(library (schemesh shell job (1 0 1))
  (export
    ...
    sh-job sh-job-id sh-job-pid sh-job-pgid sh-job-status sh-jobs sh-job-find sh-job-exception sh-job-on-finish sh-job-verbose? sh-job-verbose?-set!
    ...
    sh-start/fd1 sh-start/fds sh-start/ports
    sh-stdio-flush
    ...
    ;; wildcard
    wildcard wildcard1 wildcard1+ wildcard* wildcard/apply wildcard/expand-tilde
