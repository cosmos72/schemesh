    ...
    ((text? path-or-fd)
      (let ((c-path0 (text->bytevector0 path-or-fd)))
        (if (and job-dir (not (fx=? 47 (bytevector-u8-ref c-path0 0))))
          (let ((c-dir0 (charspan->utf8b job-dir)))
            (if (fx=? 47 (bytevector-u8-ref c-dir0 (fx1- (bytevector-length c-dir0))))
              (bytevector-append c-dir0 c-path0)
              ;; append / after job's directory
              (bytevector-append c-dir0 #vu8(47) c-path0)))
          c-path0)))
