...
(library (schemesh repl (1 0 1))
  ...
  (import
    ...
    (only (scheme2k bootstrap)            ==> assert* catch catch-all check-interrupts define-macro first-value-or-void nop raise-errorf try values->list while)
