...
#(
  ...
  (datum->wire
    (gbuffer (span #vu8(1)) (ok 9 10) (charspan #\a #\xFF)
             (chargbuffer #\< #\>)))                   #vu8(24 0 0 0 247 4 246 1 40 1 1 245 6 38 2 0 0 0 9 10 250 2 97 255 252 2 60 62)
  (datum->wire
    (eq-hashtable (void) 1.5 '() #x123456789))         #vu8(20 0 0 0 50 2 27 20 5 137 103 69 35 1 28 23 0 0 0 0 0 0 248 63)
  (datum->wire
    (eqv-hashtable #\{ 0.5+2.0i))                      #vu8(21 0 0 0 51 1 31 123 24 0 0 0 0 0 0 224 63 0 0 0 0 0 0 0 64)
  (let ((bv (datum->wire
