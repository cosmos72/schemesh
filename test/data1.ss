...
#(
  ...
  (datum->wire (make-process-entry 1 "systemd" "" 'S "root" "root" 0 0 0 1 1 14798848 25317376
    ...
    (make-time-duration 1 40000000) (make-time-duration 0 0) 20 1 12379 159))
                                                           ...
                                                           #vu8(84 239 1 41 7 115 121 115 116 101 109 100 41 0 46 1 83 41 4
  ...
  (first-value (wire->datum
    #vu8(92 239 17 205 4 41 7 115 121 115 116 101 109 100 41 0 46 1
         ...
         242 83 0 19 128 195 201 1 242 83 0 0 16 20 1 17 53 7 0)))
